...
public class MainActivity extends BaseActivity{
    ...
    private void addFragment(int pos) {
        ...
        if(fragmentlist.get(pos).statue==0){
            transaction.add(R.id.fl_mainactivity_frame,fragmentlist.get(pos).fragment,pos+"");
            fragmentlist.get(pos).statue=1;
            transaction.show(fragmentlist.get(pos).fragment);
        }else {
            transaction.show(fragmentlist.get(pos).fragment);
    ...
    private void addList() {
        ...
        for (int i=0;i<4;i++){
            ...
            switch (i){
                case  0:showfragment.fragment=fragmentHome;
                    break;
                case  1:showfragment.fragment=fragmentVideo;
                    break;
                case  2:showfragment.fragment=fragmentAttention;
                    break;
                case  3:showfragment.fragment=fragmentMy;
                    break;
            }
    ...
    private void setstatue(int id) {
        switch (id){
            case R.id.btn_main_home:btn_main_home.setSelected(true);
                btn_main_home.setTextColor(Color.RED);
                ...
                break;
            case R.id.btn_main_video:btn_main_home.setSelected(false);
                ...
                btn_main_my.setSelected(false);
                break;
            case R.id.btn_main_attention:btn_main_home.setSelected(false);
                btn_main_home.setTextColor(Color.BLACK);
                btn_main_video.setSelected(false);
                ...
                btn_main_my.setTextColor(Color.BLACK);
                break;
            case R.id.btn_main_my:btn_main_home.setSelected(false);
                btn_main_home.setTextColor(Color.BLACK);
                btn_main_video.setSelected(false);
                btn_main_video.setTextColor(Color.BLACK);
                btn_main_attention.setSelected(false);
